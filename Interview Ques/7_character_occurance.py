...
for ch in str1: # for loop iterate over the string
...
for ch in str1: # iterate over each character
    if ch not in occ: # check if character is already processed
        count = 0 # initialize the counter
        for c in str1: # compares current char. ch to every char. in c of str.
            if c == ch:
